...
public abstract class GuiBaseActiveElemеnt extends GuiBaseElement {
	
	public GuiBaseActiveElemеnt(Shader shader, int vbo, int ibo, int drawCount, Material material) {
		super(shader, vbo, ibo, drawCount, material);
		// TODO Auto-generated constructor stub
	}
	
	public GuiBaseActiveElemеnt(Shader shader, Transform transform, int vbo, int ibo, int drawCount, Material material) {
